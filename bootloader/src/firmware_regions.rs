...
#[cfg(feature = "uefi")]
pub fn reserve_firmware_boot_regions(_frame_allocator : &mut FrameAllocator<'_>, _kernel : &'static [u8], _page_table_start : Option<PhysAddr>, _page_table_end : Option<PhysAddr>){
    // nothing
}

#[cfg(not(feature = "uefi"))]
pub fn reserve_firmware_boot_regions(frame_allocator : &mut FrameAllocator<'_>, kernel : &'static [u8], page_table_start : Option<PhysAddr>, page_table_end : Option<PhysAddr>){
    use x86_64::PhysAddr;
